...
_magic_number = 10
_modified_time = 1554840237.5237906
_enable_loop = True
...
def render_site_center(context,**pageargs):
    ...
    try:
        ...
        for p in prescribers:
            __M_writer('            <tr>\r\n                <td></td>\r\n')
            if group.name == 'Health Officials' and 'Data Clerks':
